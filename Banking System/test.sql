...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4246707013ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=customers">`test`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=transactions">`test`.`transactions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=users">`test`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_term_taxonomy">`wordpress`.`wp_term_taxonomy`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_postmeta">`wordpress`.`wp_postmeta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_posts">`wordpress`.`wp_posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_termmeta">`wordpress`.`wp_termmeta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_terms">`wordpress`.`wp_terms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_usermeta">`wordpress`.`wp_usermeta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=meta_table">`wordpress`.`meta_table`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b43756522315b634752556a6066697c">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="test" targettable="customers">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customers`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="transactions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `customers` (`c_id`, `c_name`, `acc_no`, `bal`) VALUES (&#039;101&#039;, &#039;Piyush Jadhav&#039;, &#039;198723546&#039;, &#039;12020&#039;), (&#039;102&#039;, &#039;Aryan Jadhav&#039;, &#039;190237465&#039;, &#039;1001&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="test" targettable="customers">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `customers` (`c_id`, `c_name`, `acc_no`, `bal`) VALUES (&#039;109&#039;, &#039;Ram Chandravanshi&#039;, &#039;198219320&#039;, &#039;100010&#039;), (&#039;110&#039;, &#039;Niraj Deshmukh&#039;, &#039;193817312&#039;, &#039;193732&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="customers">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `customers` WHERE c_id=102;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="customers">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `customers` (`c_id`, `c_name`, `acc_no`, `bal`) VALUES (&#039;101&#039;, &#039;Piyush Jadhav&#039;, &#039;198762534&#039;, &#039;190901&#039;), (&#039;102&#039;, &#039;Aryan Jadhav&#039;, &#039;190827342&#039;, &#039;1001&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="customers">
                            <div class="action_content">
